...
# ==============================================================================
# 🛰️ TID OPERATIONS HUB (NEXUS) - 100% VERCEL SAFE & GOD TIER UI
# ==============================================================================
import urllib.request
import csv
import re
...
# ------------------------------------------------------------------------------
# 2. CACHE ENGINE & SMART ALIASES (100% SEQUENTIAL & SAFE)
# ------------------------------------------------------------------------------
...
# SAFE SEQUENTIAL LOOP (SAME AS YOUR WORKING CODE)
...
def api_nexus_ship24():
    ...
    for tid in tids:
        ...
        if ship24_key == 'MOCK':
            responses.append({"tid": tid, "success": True, "courier": "Ship24", "current_status": "Transit", "progress": 60, "eta": "In 3 Days", "signed_by": "J. SMITH", "events": [{"statusMilestone":"transit", "status": "Arrival at Hub", "time": "2026-03-01 14:30", "location": "Gateway Hub"}]})
        else:
            try:
...
def nexus_dashboard():
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .brand { font-size: 18px; font-weight: 800; display: flex; align-items: center; gap: 10px; letter-spacing: -0.5px;}
        ...
        .status-badge { padding: 6px 12px; border-radius: 6px; font-size: 12px; font-weight: 700; background: var(--border); color:var(--text); border: 1px solid var(--border);}
        ...
        <div class="main-wrapper">
            ...
            <main class="viewport">
                <div class="sync-overlay" id="syncOverlay">
                    ...
                    <p style="color:var(--muted); margin-top:10px;">Pulling live data safely. This takes a few seconds...</p>
                </div>
    ...
    <script>
            ...
            allTrackingData.forEach(item => {
                ...
                h += `<div class="track-card">
                    <div class="track-header">
                        ...
                        <div class="status-badge ${item.status.includes('DELIVERED')?'success':''}">${item.source} | ${item.status}</div>
                    </div>
                    <div class="meta-grid">
        ...
        async function syncShip24(tid, isDirect = false) {
            ...
            if(d.success) {
                ...
                extraHtml += `<a href="https://www.ship24.com/tracking?p=${tid}" target="_blank" style="display:inline-flex; align-items:center; gap:6px; background:var(--card); border:1px solid var(--border); padding:6px 12px; border-radius:6px; font-size:11px; font-weight:600; color:var(--text); text-decoration:none;">🔗 Official POD / Tracking</a></div>`;
