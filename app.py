...
def api_dashboard():
    try:
        ...
        for provider in PROVIDERS:
            ...
            # startRow is 1-based (row 2 means skip 1 header row)
            start_idx = provider.get("startRow", 2) - 1
            
            # Column indexes - ALREADY 0-BASED, use directly!
