...
PROVIDERS = [
    ...
    {'name': 'ECL LOGISTICS (QC)', 'short': 'ECL QC', 'sheet': 'Address and Tracking QC Center', 'date_col': 1, 'box_col': 3, 'weight_col': 6, 'region_col': 13, 'order_col': 0, 'start_row': 2, 'color': '#10B981', 'group': 'ECL'},
    {'name': 'ECL LOGISTICS (ZONE)', 'short': 'ECL ZONE', 'sheet': 'Address and Tracking Zone', 'date_col': 1, 'box_col': 4, 'weight_col': 8, 'region_col': 16, 'order_col': 0, 'start_row': 3, 'color': '#F59E0B', 'group': 'ECL'},
...
# ECL alag spreadsheet - published URLs (user ne share kiye, no row limit)
ECL_PUBLISHED = {
