...
# ==============================================================================
# 🛰️ TID OPERATIONS HUB (NEXUS) - 100% COMPLETE & EXACT DATA MATCH EDITION
# ==============================================================================
import urllib.request
import csv
import re
...
def login_required(f):
    @wraps(f)
    def decorated_function(*args, **kwargs):
        # NOTE: Agar login baar bar hat raha ho test karte waqt toh in 2 lines ko comment kar dein
...
# 🚨 APX/Kerry headers specifically added here 🚨
STRICT_ALIASES = {
                ...
                <div id="view-track" class="view-pane active">
                    ...
                    <div class="card" style="margin-bottom: 30px;">
                        ...
                        <div style="margin-top: 20px; display: flex; gap: 12px;">
                            ...
                            <button class="btn btn-purple" id="bulkBtn" onclick="bulkTrackAll()" style="display:none; background:#8B5CF6;">⚡ Bulk Sync Carriers</button>
    ...
    <script>
        ...
        async function forceGlobalSync() {
            ...
            try {
                ...
                alert("⚠️ Sync timeout. Wait 5 seconds and click Sync again.");
            }
        ...
        async function searchOrders() {
            ...
            try {
                ...
                if(r.status === 400) throw new Error("Need Sync");
                allTrackingData = await r.json(); 
                
                if(allTrackingData.length > 0) document.getElementById('bulkBtn').style.display = 'flex';
                renderCards();
            } catch (error) {
                resDiv.innerHTML = '<div class="error-box">⚠️ Please click the green "Sync Live Data" button at the top right first!</div>';
            }
        }
...
# ==============================================================================
# 🛰️ TID OPERATIONS HUB (NEXUS) - EXACT DATA MATCH & ANTI-FREEZE EDITION (END)
# ==============================================================================
if __name__ == '__main__':
    app.run(debug=True)
