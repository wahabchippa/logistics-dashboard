...
<style>
    ...
    * {
    ...
    .logo-icon {
        width: 36px;
        height: 36px;
        background: linear-gradient(135deg, #B89B5E, #9A8048);
        border-radius: 8px;
        display: flex;
        align-items: center;
    ...
    .logout-btn:hover {
        background: rgba(194, 126, 126, 0.1);
    }
